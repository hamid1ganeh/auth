                        ...
                        <div class="card">
                            ...
                            @if (\Session::has('errors'))
                                <div class="alert alert-danger">
                                    <ul>
                                        <li class="IR">{!! \Session::get('errors') !!}</li>
                                    </ul>
                                </div>
                            @endif
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <a href="index.html">
                                        <span><img src="{{ url('/') }}/panel/assets/images/logo.png" alt="پارلمان" width="100"></span>
                                    </a>
